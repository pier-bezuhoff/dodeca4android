    ...
    fun translateCanvas() {
        if (holder.surface.isValid) {
            ...
            try {
                ...
                Log.e("MainActivity", "DodecaSurfaceView > withCanvas > holder.lockCanvas:\n${e.getStackTraceString()}")
                e.printStackTrace()
            } finally {
                canvas?.let {
                    try {
                        ...
                        Log.e(
                            "MainActivity",
                            "DodecaSurfaceView > withCanvas > holder.unlockCanvasAndPost:\n${e.getStackTraceString()}"
                        )
                        e.printStackTrace()
                    }
                }
            ...
            try {
                ...
                canvas?.let {
                    try {
                        ...
                        Log.e("MainActivity", "DodecaSurfaceView > withCanvas > holder.unlockCanvasAndPost:\n${e.getStackTraceString()}")
                        e.printStackTrace()
                    }
                }
            }
